...
INSERT INTO beers (beer_abv, beer_ibu, beer_style, beer_description, beer_name , brewery_id , beer_image )
VALUES ('5.2% ABV', '35 IBU', 'American IPA', 'Punk IPA is the beer that kick-started it. This light, golden classic has been subverted with new world hops to create an explosion of flavour. Bursts of caramel and tropical fruit with an all-out riot of grapefruit, pineapple and lychee, precede a spiky bitter finish. This is the beer that started it all - and its not done yet...', 'Punk IPA' , 2, 'https://untappd.akamaized.net/photos/2021_08_10/b1598ad5f807a633dec2339d92c89836_raw.jpg' );



INSERT INTO beers (beer_abv, beer_ibu, beer_style, beer_description, beer_name , brewery_id , beer_image )
VALUES ('5.2% ABV', '28 IBU', 'American Amber Ale', 'Our house Amber Ale, Tenpenny Ale balances sweet, caramel malt with a mildly bitter, fragrant hop nose. Underneath those flavors lurks a powerhouse yeast that contributes the classic ale ester profile rather than the too clean flavors in modern beer. Tenpenny Ale is unpasteurized and never filtered, its beer the way it was intended to be.', 'Tenpenny Ale' , 3, 'https://drinkupcolumbus.com/wp-content/uploads/2014/04/tenpenny-homestead-beer-co.jpg' );

INSERT INTO beers (beer_abv, beer_ibu, beer_style, beer_description, beer_name , brewery_id , beer_image )
VALUES ('7.5% ABV', '50 IBU', 'American Pale Ale', 'Snake Oils sly, mild bitter sits on top of a dry, crisp "Super" American Pale Ale and the giant hop notes reach out to bite you – dominated by those California notes of mango, grapefruit, passion fruit and backed by classic pine and resin its a hop lovers paradise.', 'Snake Oil' , 3, 'https://untappd.akamaized.net/photos/2018_12_17/ef2f9762838e85780808cd475aad6466_640x640.jpg' );
