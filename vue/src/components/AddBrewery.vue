<template>
    ...
    <form class="form" @submit.prevent="addBrewery">
      <div>
        ...
        <input type="text" id="name" v-model="brewery.name"  />
      </div>
      <div>
      ...
      <div>
        ...
        <select v-model="brewery.state" required id="state" name="state">
          <option value="---">---</option>
      ...
      <div>
        ...
        <input type="text" id="zip" v-model="brewery.zipCode"  />
      </div>
      <div>
        <label for="phone">Phone Number:</label>
        <input type="text" id="phone" v-model="brewery.phoneNumber"  />
      </div>
      <div>
